...
// we use "@Entity" to denote that this is going to be stored in a database
public class GymLog {
    @PrimaryKey(autoGenerate = true) // PrimaryKey is a unique identifier for a piece of data
    private int id;
